    ...
    return (
        <Card elevation={6}>
            ...
            <CardContent>
                ...
                {place?.address && (
                    <Typography gutterBottom variant="subtitle2" className={classes.subtitle} color="textSecondary">
                        <LocationOnIcon /> {place.address}
                    </Typography>
                )}
                {place?.phone && (
                    <Typography gutterBottom variant="subtitle2" className={classes.spacing} color="textSecondary">
